...
QUOTES_DB_URL = "https://raw.githubusercontent.com/JamesFT/Database-Quotes-JSON/master/quotes.json"
LOCAL_DB_PATH = Path("app/data/quotes.json")
...
def get_random_quote() -> Dict[str, str]:
    ...
    try:
        ...
        return {"quoteText": "Error reading quotes database.", "quoteAuthor": "System"}

def format_quotes_receipt(printer, config: Dict[str, Any] = None, module_name: str = None):
