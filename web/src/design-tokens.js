...
export const commonClasses = {
  // Input fields
  input: 'w-full p-3 text-base bg-white border-2 border-gray-300 rounded-lg text-black focus:border-black focus:outline-none ',
  inputSmall: 'w-full p-2 text-sm bg-white border-2 border-gray-300 rounded-lg text-black focus:border-black focus:outline-none ',
  ...
  // Cards
  card: 'bg-white border-2 border-gray-300 rounded-lg p-4',
  cardNested: 'bg-gray-50 p-3 rounded-lg border-2 border-gray-300',
  cardNestedSmall: 'bg-gray-50 p-2 rounded-lg border-2 border-gray-300',
  ...
  buttonSecondary: 'px-4 py-2 bg-transparent border-2 border-gray-400 hover:border-black rounded-lg text-black  transition-colors cursor-pointer hover-shimmer',
  ...
  buttonGhost: 'text-xs px-2 py-0.5 rounded border-2 bg-transparent text-gray-500 border-gray-400 hover:text-black hover:border-black  transition-colors cursor-pointer hover-shimmer',
